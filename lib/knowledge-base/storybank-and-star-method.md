...
The storybank table is a quick-reference index. For each story, also capture the full STAR text including Situation, Task, Action, Result, Earned Secret, and deployment use-case.
...
- **Freshness risk**: Stories used in prior rounds at a current company loop should not be reused unless the interviewer explicitly asks for elaboration.
